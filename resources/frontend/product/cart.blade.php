        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-9 col-sm-12 col-12">
                    ...
                    <div class="your-cart-flex">
                        @if(!Session::exists('cart'))
                            ...
                            <div class="empty-cart details">
                                <a href="javascriptvoid:(0)"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>
                                    EMPTY CART</a>
                            </div>
                        @else
                            ...
                            <div class="your-cart-txt">
                                <h6>Your
                                    Cart:{{count(session('cart'))}} {{count(session('cart')) <= 1 ? 'item' : 'Items' }} </h6>
                            </div>
                    ...
                    <div class="pro-check-btn">
                        <div class="con-shop-btn details">
                            <a href="{{url('collection/all')}}">CONTINUE SHOPPING</a>
                        </div>
                        @if(Session::exists('cart'))
                            @if(count(session('cart')) == 0)
                                <div class="proceed-btn">
                                    <a href="{{url('checkout')}}" disabled="disabled">PROCEED TO CHECKOUT <i
                    ...
                    <div class="left-items">
                        <p>You may have left items in your cart earlier <a class="text-hover" href="{{url('login')}}">Login</a>
                            to view your cart now. Already logged-in or do not have one? please disregard this message.
                        </p>
                    </div>
                    <div class="got-policy">
                        ...
                        <ul>
                            ...
                            <li>99% customer satisfaction on GotApparel.com, 98% positive Feedback on our Amazon Store,
                                and 99.5% positive Feedback on our EBAY Store.
                            </li>
                            <li>Payment options: PayPal Express, Amazon Checkout, Visa, Master Card, American Express,
                                Discover.
                            </li>
                            <li><span><a class="text-hover" href="{{url('page/returns-exchanges')}}">Easy returns and Exchanges</a>,</span>
                                <span><a class="text-hover"
                                         href="javascriptvoid:(0)">Toll free Customer Service</a></span> and <span><a
                                            class="text-hover" href="javascriptvoid:(0)">Email.</a></span></li>
                            <li>Your GotApparel Store is maintained safe and secure with the help of <span><a
                                            class="text-hover" href="javascriptvoid:(0)">McAffee Secure</a>,</span>
                                <span><a class="text-hover" href="javascriptvoid:(0)">GeoTrust</a>,</span> and <span><a
                                            class="text-hover" href="javascriptvoid:(0)">Authorize.net.</a></span></li>
                        </ul>
                    </div>
                ...
                <div class="col-md-3 col-sm-12 col-12">
                    <div class="your-order-detail">
                        ...
                        <p>Your order will be shipped via UPS Ground or USPS. Tracking number will be posted on <span>Order Status</span>
                            as they become available. 98% of the orders are delievered with in two days.</p>
                    </div>
                    ...
                    <div class="your-order-privacy">
                        <h6>YOUR PRIVACY</h6>
                        <p>Fjackets.com respects the privacy of its valued customers. For more details please read our
                            privacy policy.</p>
                    </div>
                    <div class="your-order-privacy">
                        <h6>CREDIT CARD SECURITY</h6>
                        <p>All personal information you submit is encrypted using Secure Socket Layer (SSL) protection.
                            Other payment methods also available.</p>
                        <a href="javascriptvoid:(0)"><img src="{{asset('frontend/ecommerce/images/paypal-img.png')}}"

            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-12">
                    <div class="bread-crumb">
                        <ul>
                            <li><a href="{{url('/')}}" class="text-hover disable-cls">Home</a></li>
                            <li><i class="fa fa-long-arrow-right" aria-hidden="true"></i></li>
                            <li><a class="text-hover bold-cls" href="javascriptvoid:(0)">Contact Us</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row solutions-cls">
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="solutions-boxes">
                        <img src="contac/qu1.png" alt="image">
                        <h6>Track Order</h6>
                        <a href="{{url('page/track-order')}}">FIND ANSWERS NOW</a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="solutions-boxes">
                        <img src="contac/qu2.png" alt="image">
                        <h6>Return Portal</h6>
                        <a href="{{url('page/return-request')}}">FIND ANSWERS NOW</a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="solutions-boxes">
                        <img src="contac/qu3.png" alt="image">
                        <h6>FAQ's</h6>
                        <a href="{{url('page/faqs')}}">FIND ANSWERS NOW</a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="solutions-boxes">
                        ...
                        <a href="{{url('page/returns-exchanges')}}">FIND ANSWERS NOW</a>
                    </div>
                </div>
            </div>
            <div class="row solutions-cls">
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="solutions-boxes">
                        <img src="contac/qu4.png" alt="image">
                        <h6>Shipping & Delivery</h6>
                        <a href="{{url('page/shipping-delivery')}}">FIND ANSWERS NOW</a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="solutions-boxes">
                        <img src="contac/qu5.png" alt="image">
                        <h6>Size Guide</h6>
                        <a href="{{url('page/size-guide')}}">FIND ANSWERS NOW</a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="solutions-boxes">
                        <img src="contac/qu6.png" alt="image">
                        <h6>Partnership & Collaboration</h6>
                        <a href="{{url('page/partnership-collaboration')}}">FIND ANSWERS NOW</a>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="solutions-boxes">
                        <img src="contac/qu7.png" alt="image">
                        <h6>About Us</h6>
                        <a href="{{url('page/about-us')}}">FIND ANSWERS NOW</a>
                    </div>
                </div>
            </div>
        </div>

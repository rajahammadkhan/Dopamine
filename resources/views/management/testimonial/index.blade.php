        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <a href="{{route('testimonial.create')}}" type="button" class="btn btn-primary"> Add
                                Testimonial
                            </a>
                        </div>
                                ...
                                @foreach($data as $row)
                                    <tr>
                                        <td>
                                            ...
                                            @endif
                                            <img style="" src="{{asset('images'.'/'.$image)}}" height="60px"
                                                 width="60px">
                                        </td>
                                        <td> {{$row->title}}
                                        </td>
                                        ...
                                        <td>
                                            <a class="btn bg-blue btn-circle"
                                               href="{{route('testimonial.show',$row->id)}}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{route('testimonial.destroy',$row->id)}}"
                                                                  method="post">
                                                                @csrf
                                                                @method('DELETE')

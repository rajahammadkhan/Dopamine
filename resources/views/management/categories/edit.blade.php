        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                @php
                    $bl = $_GET['type'];
                @endphp
                <form action="{{route('categories.update',$category->id)}}?type={{$bl}}" method="POST"
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{$categoryDetail->title ?? ''}}" type="text"
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value=" {{$seo != null ? $seo->meta_title : ''}} " type="text"
                                                       id="erp_question_text"
                                    ...
                                    <div class="row my-4">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{$seo != null ? $seo->meta_keywords : ''}}" type="text"
                                                       id="erp_question_text"
                                            ...
                                            <select class="form-control select2" name="parent_category" id="Quiz-type"
                                                ...
                                                @foreach($all_category as $row)
                                                    ...
                                                    @if($row->reference_type == $rr)
                                                        <option
                                                            {{$category->parent_category == $row->id ? 'selected' : ''}}   value={{$row->id}}>{{$row->title}} </option>
                                                    @endif
                                                @endforeach
                                    ...
                                    <div class="row my-4">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control"
                                                   value="{{$language->language_name ?? ''}}" id="Quiz-type" disabled>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="img-thumb">
                                                        ...
                                                        @else
                                                            <img class="main_img d-block w-100 h-100 position-absolute"
                                                                 src="{{asset('images/media'.'/'.$multi->image)}}"
                                                                 alt="{{$category->title}}">
                                                        @endif
                                                    </div>
                                                </div>

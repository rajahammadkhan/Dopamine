                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{$package_detail->title}}" type="text" id="title"
                                        ...
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2" name="country" id="country"
                                                ...
                                                @foreach($countries as $country)
                                                    <option {{$country->name == $package_detail->country ? 'selected' : ''}} value="{{$country->id}}">{{$country->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class=" col-12">
                                            ...
                                            <input type="text" value="{{$package_detail->city}}" name="city" class="form-control" placeholder="City Name">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row my-1">
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2" name="status" id="Quiz-type"
                                                    data-placeholder="Select">
                                                <option {{$package_detail->status == '1' ? 'selected' : ''}}   value=1>
                                                    Publish
                                                </option>
                                                <option {{$package_detail->status == '0' ? 'selected' : ''}}  value=0>draft
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row my-1">
                                        <div class=" col-12 mt-4">
                                            ...
                                            <select class="form-control select2" name="select_package" id="Quiz-type"
                                                    data-placeholder="Select">
                                                <option {{$package_detail->select_package == '1' ? 'selected' : ''}}   value=1>
                                                   Enquiry Package
                                                </option>
                                                <option {{$package_detail->select_package == '0' ? 'selected' : ''}}  value=0>Selling Package
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if($hotel->isNotEmpty())
                                                    @foreach($hotel as $hotels)
                                                        <label class="d-block">
                                                            <input {{ in_array($hotels->id,json_decode($package->hotel_id)) ? 'checked' : ''}} value="{{$hotels->id}}" type="checkbox"
                                    ...
                                    <div class="row my-3">
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2" name="category_id" id="Quiz-type"
                                                ...
                                                @foreach($cate as $row)
                                                    <option {{ $package->category_id == $row->id ? 'Selected' : '' }}   value={{$row->id}}>{{$row->title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="main_container m-3">
                                                        <div class="main imagebox position-relative rounded-3 overflow-hidden">
                                                            ...
                                                            <div class="img-thumb">
                                                                @if($img == null)
                                                                @else
                                                                    <input type="hidden" name="itinerary_update[]" value="{{$img->image}}">
                                                                    <img class="main_img d-block w-100 h-100 position-absolute"
                                                                         src="{{asset('images/media'.'/'.$img->image)}}"
                                                                         alt="">
                                                                @endif
                                                            </div>
                                                        </div>

...
@section('title')
    Holidays Edit - {{config('app.dashboard')}}
@endsection
@section('content')
    <style>
    ...
    <div class="container-fluid px-4">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <form action="{{route('holidays.update',$holidays->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{$holidays->title}}" type="text" id="title"
                                    ...
                                    <div class="row my-1">
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2" name="status" id="Quiz-type"
                                                ...
                                                <option {{$holidays->status == '1' ? 'selected' : ''}}   value= 1>Publish</option>
                                                <option {{$holidays->status == '0' ? 'selected' : ''}}  value= 0>draft</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row my-4">

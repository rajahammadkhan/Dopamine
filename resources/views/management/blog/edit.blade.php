                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{$blogsDetail->title}}" type="text"
                                ...
                                <div class="header">
                                        ...
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2" name="category_id" id="Quiz-type"
                                                ...
                                                @foreach($all_category as $row)
                                                    <option
                                                        {{$category->category_id==$row->id ? 'selected' : ''}}  value={{$row->id}}>{{$row->title}}</option>
                                                @endforeach
                                    ...
                                    <div class="row my-4">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" value="{{$language->language_name}}"
                                                   id="Quiz-type" disabled>
                                        </div>
                                    </div>

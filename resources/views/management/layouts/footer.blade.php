...
<script>
    const handleClone = (e) => {
        // $(".highlightContainer .highlight:first").clone().insertAfter($(e).parents('highlightContainer'));

        console.log(e.parentNode.parentNode.querySelector('.highlight'))

        e.parentNode.parentNode.appendChild(e.closest('div').parentNode.querySelector('.highlight').cloneNode(true));

    }
    const handleRemove = (e) => {
        // $(this).parents('highlight').remove();

        console.log($(e).parents('highlight'), e.closest('.highlight').remove())
    }
</script>
